...
public class CTFPathThreadHelper implements Runnable
{
	...
	public CTFPathThreadHelper(Main main, Point startLocation, Point endLocation, int pathNumber, String message)
	{
		this.main = main;
	...
	private void finish()
	{
		...
		// }
		// if (this.solution.get(this.solution.size() -
		// 1).equals(this.main.homeBase)){
		// this.solution.remove(this.solution.size() - 1);
		// }

		this.core.paths.put(this.pathNumber, this.solution);
	}
	...
	private void quitThisProcess()
	{
		...
		System.out.println("Thread Completed for path (" + this.startLocation.x + "," + this.startLocation.y + ") to (" + this.endLocation.x + "," + this.endLocation.y + ")");
		// System.out.println("Number of touched Nodes: " +
		// this.numOfTouchedNodes);
		// System.out.println("Number of closed Nodes: " +
		// this.closedMoves.size());
		// System.out.println("Number of open Nodes: " + this.openMoves.size());
		this.core.pathFinders.remove(this);
		this.stop();
	}
